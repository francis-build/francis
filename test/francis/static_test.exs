defmodule Francis.StaticTest do
  ...
  # TODO: add static_url
  # describe "static_url/3" do
  #   test "returns full URL with digested path" do
  #     assert Francis.Static.static_url("app.css", "/assets", @test_manifest_path) ==
  #              "/assets/app-a1b2c3d4.css"

  #     assert Francis.Static.static_url("app.js", "/static", @test_manifest_path) ==
  #              "/static/app-e5f6g7h8.js"
  #   end

  #   test "handles nested paths correctly" do
  #     assert Francis.Static.static_url("images/logo.png", "/assets", @test_manifest_path) ==
  #              "/assets/images/logo-i9j0k1l2.png"
  #   end

  #   test "uses default static path when not provided" do
  #     assert Francis.Static.static_url("app.css", "/", @test_manifest_path) == "/app-a1b2c3d4.css"
  #   end

  #   test "returns original URL when asset doesn't exist" do
  #     assert Francis.Static.static_url("nonexistent.css", "/assets", @test_manifest_path) ==
